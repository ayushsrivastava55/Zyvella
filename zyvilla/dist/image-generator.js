 ...
 */
async function removePersonBackground(imageUrl) {
 ...
 */
async function generateWithJewelryReference(jewelryImageUrl, prompt) {
 ...
 */
async function tryOnVirtually(personImageUrl, jewelryImageUrl, prompt) {
...
function enhanceJewelryPrompt(originalPrompt, jewelryImageUrl) {
